...
<body style="">
    ...
    <div class="wrapper fadeInDown">
        <div id="formContent">
          ...
          <!-- Login Form -->
          <form id="admin-register-form" action="{{ action('App\Http\Controllers\UserAuthController@register') }}" method="POST">
            <input type="text" id="name" class="fadeIn second" name="name" placeholder="Enter your name">
            <input type="email" id="email" class="fadeIn third" name="email" placeholder="Enter your email">
            <input type="text" id="phone" class="fadeIn fourth" name="phone" placeholder="Enter your phone number">
            <input type="password" id="pass" class="fadeIn fifth" name="pass" placeholder="Enter password">
            <input type="password" id="cpass" class="fadeIn sixth" name="cpass" placeholder="Confirm password">
            <button type="submit" class="fadeIn seventh aut-btn">Register</button>
