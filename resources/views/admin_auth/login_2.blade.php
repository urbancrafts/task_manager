...
<body style="">
    ...
    <div class="wrapper fadeInDown">
        <div id="formContent">
          ...
          <!-- Login Form -->
          <form id="admin-login-form" action="{{ action('App\Http\Controllers\UserAuthController@login') }}" method="POST">
            <input type="text" id="login-email" class="fadeIn second" name="login" placeholder="Enter Email">
            <input type="password" id="login-pass" class="fadeIn third" name="login" placeholder="Enter password">
            <button type="submit" class="fadeIn fourth aut-btn">Log In</button>
            
            <p>You don't have an account with us? <a class="underlineHover" href="{{url('/admin_register')}}">Signup</a></p>
          </form>
